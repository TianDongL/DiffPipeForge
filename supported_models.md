...
## Qwen-Image or Qwen Image Edit 2512
```
[model]
type = 'qwen_image'
diffusers_path = '/data/imagegen_models/Qwen-Image'
...
# Or use the ComfyUI version of the model
...
# May require higher block swap, block swap≤57
```
All LoRAs are saved in ComfyUI format.
Additionally, supports multi-image editing training:
...
```
Or for single-image editing training like this:
```
[[directory]]
path = '/input/test'
